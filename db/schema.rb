...
ActiveRecord::Schema.define(version: 20170401063056) do
  ...
  create_table "spree_skrill_transactions", force: :cascade, options: "ENGINE=InnoDB DEFAULT CHARSET=utf8" do |t|
    t.string   "email"
